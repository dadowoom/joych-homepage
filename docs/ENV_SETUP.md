...
export PUBLIC_URL_BASE="https://joych.org"
```
...
| `PUBLIC_URL_BASE` | OAuth 콜백·SEO·업로드 URL의 대표 도메인 | `https://joych.org` |
...
```
https://joych.org/api/member-oauth/google/callback
https://joych.org/api/member-oauth/kakao/callback
```
