 ...
 * 디자인: 녹색(#2d6a4f) 포인트 + MinistryPage 템플릿 재사용
 */
...
const discipleInfo: MinistryInfo = {
  name: "제자훈련",
...
const oneOnOneInfo: MinistryInfo = {
  name: "일대일 양육",
  vision: "개인 맞춤형 신앙 성장",
...
const sunseumInfo: MinistryInfo = {
  name: "순세움학교",
...
const saengseonInfo: MinistryInfo = {
  name: "생선 컨퍼런스",
...
const worldMissionInfo: MinistryInfo = {
  name: "세계선교부",
...
const evangelismInfo: MinistryInfo = {
  name: "기쁨의 전도부",
...
const prayerMinistryInfo: MinistryInfo = {
  name: "기도사역부",
  vision: "기도로 세워지는 교회",
...
const welfareInfo: MinistryInfo = {
  name: "기쁨의 복지재단",
...
const visionUnivInfo: MinistryInfo = {
  name: "비전대학",
...
export function HesedAsiaPage() {
  return <MinistryPage title="헤세드아시아포재팬" breadcrumb={["양육/훈련", "헤세드아시아포재팬"]} info={hesedInfo} />;
}
export function DiscipleTrainingPage() {
  return <MinistryPage title="제자훈련" breadcrumb={["양육/훈련", "제자훈련"]} info={discipleInfo} />;
}
export function ElderTrainingPage() {
  return <MinistryPage title="순장 훈련" breadcrumb={["양육/훈련", "순장"]} info={elderInfo} />;
}
export function OneOnOnePage() {
  return <MinistryPage title="일대일 양육" breadcrumb={["양육/훈련", "일대일양육"]} info={oneOnOneInfo} />;
}
export function SunseumSchoolPage() {
  return <MinistryPage title="순세움학교" breadcrumb={["양육/훈련", "순세움학교"]} info={sunseumInfo} />;
}
export function SaengseonConferencePage() {
  return <MinistryPage title="생선 컨퍼런스" breadcrumb={["양육/훈련", "생선 컨퍼런스"]} info={saengseonInfo} />;
}

export function WorldMissionPage() {
  return <MinistryPage title="세계선교부" breadcrumb={["사역/선교", "세계선교부"]} info={worldMissionInfo} />;
}
export function EvangelismPage() {
  return <MinistryPage title="기쁨의 전도부" breadcrumb={["사역/선교", "기쁨의 전도부"]} info={evangelismInfo} />;
}
export function PrayerMinistryPage() {
  return <MinistryPage title="기도사역부" breadcrumb={["사역/선교", "기도사역부"]} info={prayerMinistryInfo} />;
}
export function WelfarePage() {
  return <MinistryPage title="기쁨의 복지재단" breadcrumb={["사역/선교", "기쁨의 복지재단"]} info={welfareInfo} />;
}
export function VisionUniversityPage() {
  return <MinistryPage title="비전대학" breadcrumb={["사역/선교", "비전대학"]} info={visionUnivInfo} />;
}
export function JoyLabPage() {
  return <MinistryPage title="조이랩" breadcrumb={["사역/선교", "조이랩"]} info={joyLabInfo} />;
}
