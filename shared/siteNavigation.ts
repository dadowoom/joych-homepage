...
export const INTERNAL_PAGES: InternalPageGroup[] = [
  {
    group: "교회소개",
    pages: [
      { label: "담임목사 인사", path: "/page/교회소개-담임목사-소개" },
      { label: "교회 역사", path: "/about/history" },
      { label: "교회 비전", path: "/page/교회소개-3대-비전" },
      { label: "섬기는 분", path: "/page/교회소개-섬기는-분" },
      { label: "교회백서", path: "/page/교회소개-교회백서" },
  ...
  { group: "선교보고", pages: [{ label: "선교보고 목록", path: "/mission" }] },
  {
    group: "커뮤니티",
    pages: [
      { label: "교회 소식", path: "/page/행정지원-공지사항" },
      ...
      { label: "사진", path: "/page/커뮤니티-최근-행사-사진" },
      { label: "생선 간증", path: "/community/testimony" },
  ...
  },
  {
    group: "행정지원",
    pages: [
      { label: "헌금 안내", path: "/support/offering" },
      ...
      { label: "조이플스토어", path: "/support/store" },
      { label: "기부금 영수증", path: "/support/donation" },
...
export const FALLBACK_NAV_ITEMS: FallbackNavItem[] = [
  {
    ...
    subHref: {
      "담임목사 소개": "/page/교회소개-담임목사-소개",
      예배안내: "/worship/schedule",
      "섬기는 분": "/page/교회소개-섬기는-분",
      교회백서: "/page/교회소개-교회백서",
  ...
  },
  {
    ...
    subHref: {
      ...
      동호회: "/community/club",
      사진: "/page/커뮤니티-최근-행사-사진",
      "생선 간증": "/community/testimony",
      기쁨톡: "/community/joytalk",
      "HOT NEWS": "/page/행정지원-공지사항",
      공지사항: "/page/행정지원-공지사항",
    },
  },
  {
    ...
    subHref: {
      ...
      탐방신청: "/support/tour",
      조이풀빌리지: "/support/store",
      "기부금 영수증": "/support/donation",
    },
  },
];
